...
class HelperFunctions:
    ...
    @staticmethod
    def find_parent_folder_id(cursor: sqlite3.Cursor, user_id: int, folder_id: int) -> int | None:
    ...
    @staticmethod
    def walk_folder(cursor: sqlite3.Cursor, user_id:int, location:int = 0, depth:int = 0) -> list[Folder]:
...
class SQLite_Utils:
    ...
    @staticmethod
    def safe_execute_query(cursor: sqlite3.Cursor, query: str):
